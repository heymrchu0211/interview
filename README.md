...
디자이너와 개발자의 중간역할을 하는게 일반적인 웹퍼블리셔의 역할이라고 생각합니다. 디자이너에게 디자인 시안을 전달받고 그 디자인 시안을 토대로 웹표준과 웹접근성을 준수하면서 html,css 그리고 자바스크립트를 활용하여 웹에 표현하는 일을 합니다. 프론트단이 백엔드단과 연동이 되는 작업을 하기 바로 이전 단계를 작업하는 것이 웹퍼블리셔의 역할이라고 할 수 있습니다.<br>

그런데 회사마다 웹퍼블리셔의 역할을 각기 다르게 보는 것 같습니다. 채용공고를 보면 디자인과 퍼블리싱을 겸하는 경우도 있고 또는 제가 말씀드린 것처럼 디자이너와 개발자의 중간역할인 경우도 있고 아니면 퍼블리셔(프론트개발자) 라고 표기하여 프론트개발자와 별다른 구분이 없이 한데 묶어서 같은 직군으로 보는 회사도 있는 것 같습니다.<br>
...
현재는 웹퍼블리셔로서 일을 하기 위해 구직활동을 하고 있지만 장기적으로 봤을때는 프론트개발자를 지향하는 방향으로 가고 싶습니다.<br> 
제가 만약 웹퍼블리셔로 일을 한다고 하더라도 혼자서만 일하는게 아니고 개발단계에서 어떤식으로 일이 진행되는지를 알아야 원활한 협업이 이루어질 수 있을꺼라 생각하기 때문입니다. 그리고 개인적으로도 프론트개발을 공부하고 싶은 욕심이 있습니다.
